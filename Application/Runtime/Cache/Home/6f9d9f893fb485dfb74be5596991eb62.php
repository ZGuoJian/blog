...
<head>
    ...
    <link href="<?php echo PUBLIC_HOME ?>assets/fancyBox/source/jquery.fancybox.css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="<?php echo PUBLIC_HOME ?>assets/fancyBox/source/jquery.fancybox.js"></script>
