            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="" class="thumbnail">
                        <img src="<?php echo PUBLIC_HOME ?>assets/img/works.png" alt="作品展示">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="" class="thumbnail">
                        <img src="<?php echo PUBLIC_HOME ?>assets/img/about.png" alt="路人简介">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="" class="thumbnail">
                        <img src="<?php echo PUBLIC_HOME ?>assets/img/book.png" alt="作品推荐">
                    </a>
                </div>
            </div>
        </div>
