    ...
    <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
            <li>
              ...
              <div class="navbar-form navbar-right" role="group">
                  <button type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                  ><a href="/blog/index.php/Admin/User/manage_admin">显示所有用户</a></button> 
            </div>
              <form action="/blog/index.php/Admin/User/manage_admin" method="post" class="navbar-form navbar-right" role="search">
          ...
          <table class="table table-striped table-hover">
            ...
            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
              <tr>
                ...
                <?php if($vo["permis"] == 0): ?><td>普通管理员</td>
                <?php elseif($vo["permis"] == 1): ?>
                    <td>系统管理员</td><?php endif; ?>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="/blog/index.php/Admin/User/add_admin" method="post" autocomplete="off" draggable="false">
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" class="form-control" name="new_password" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
                  <td wdith="20%">权限:</td>
                  <td>
