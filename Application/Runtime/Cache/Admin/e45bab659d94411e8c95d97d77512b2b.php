...
<section class="container-fluid">
  ...
  <!-- <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/blog/index.php/Admin/Article/update_article/id/<?php echo ($arr["id"]); ?>" method="post" class="add-article-form">
          <div class="col-md-9">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="category" type="radio" value="栏目1">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>1</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="category" type="radio" value="栏目2">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>2</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="category" type="radio" value="栏目3" checked>
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>3</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="category" type="radio" value="栏目4">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>4</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="category" type="radio" value="栏目5">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="输入新标签" value="<?php echo ($arr["label"]); ?>" name="tags" autocomplete="off">
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="<?php echo PUBLIC_ADMIN ?>images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
...
<script src="<?php echo PUBLIC_ADMIN ?>js/bootstrap.min.js"></script> 
<script src="<?php echo PUBLIC_ADMIN ?>js/admin-scripts.js"></script>
<script src="<?php echo PUBLIC_ADMIN ?>lib/ueditor/ueditor.config.js"></script> 
<script src="<?php echo PUBLIC_ADMIN ?>lib/ueditor/ueditor.all.min.js"> </script> 
<script src="<?php echo PUBLIC_ADMIN ?>lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
