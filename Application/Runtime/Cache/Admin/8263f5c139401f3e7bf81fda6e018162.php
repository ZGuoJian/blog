...
<section class="container-fluid">
  ...
  <!-- <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/blog/index.php/Admin/Article/add_article" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="column" type="radio" value="栏目1" checked>
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>1</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="column" type="radio" value="栏目2">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>2</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="column" type="radio" value="栏目3">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>3</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="column" type="radio" value="栏目4">
                      这是栏目 <em class="hidden-md">( 栏目ID: <span>4</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="column" type="radio" value="栏目5">
