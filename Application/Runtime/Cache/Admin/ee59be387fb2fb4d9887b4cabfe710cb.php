...
<section class="container-fluid">
    ...
    <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
            <li>
              <div class="navbar-form navbar-right" role="group">
                    <button type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                    ><a data-toggle="modal" data-target="#addUser">增加用户</a></button> 
              </div>
              <div class="navbar-form navbar-right" role="group">
                  <button type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                  ><a href="/blog/index.php/Admin/User/manage_user">刷新</a></button> 
            </div>
              <form action="/blog/index.php/Admin/User/manage_user" method="post" class="navbar-form navbar-right" role="search">
                  <div class="input-group">
                    <input type="text" class="form-control" autocomplete="off" placeholder="用户名搜索" maxlength="15" name="para">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
              <tr>
                ...
                <td>
                  <a rel="1" data-toggle="modal" data-target="#seeUser">修改</a> 
                  <a rel="1" href="/blog/index.php/Admin/User/delete_blog_user/id/<?php echo ($vo["id"]); ?>">删除</a> 
                  <a href="/blog/index.php/Admin/User/ban">禁用</a>
                </td>
              </tr>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="/blog/index.php/Admin/User/add_blog_user" method="post" autocomplete="off" draggable="false">
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">邮箱</td>
                <td width="80%"><input type="text" value="" class="form-control" name="mail" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">新密码:</td>
